            ...
            <div class="panel-body">
				<?php echo form_open(base_url() . 'admin/invoice/take_payment/'.$row['invoice_id'], array(
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input readonly type="text" class="form-control" value="<?php echo ($row['amount'] - $row['amount_paid']);?>" readonly/>
		                </div>
		            </div>
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-sm-6">
		                    <input type="text" class="form-control" name="amount" value="<?php echo ($row['amount'] - $row['amount_paid']);?>"
                    ...
                    <div class="form-group">
	                    ...
	                    <div class="col-sm-6">
	                        <input type="text" class="datepicker form-control" value="<?php echo date("m/d/Y"); ?>" name="timestamp" 
	                            value=""/>
	                    </div>
					</div>
