...
-->
    ...
    <div id="invoice_print">
        <table width="100%" border="0">
            <tr>
                <td align="right">
                    <h5><?php echo get_phrase('creation_date'); ?> : <?php echo date('d M, Y', strtotime($row['creation_timestamp']));?></h5>
                    <h5><?php echo get_phrase('title'); ?> : <?php echo $row['title'];?></h5>
                    <h5><?php echo get_phrase('description'); ?> : <?php echo $row['description'];?></h5>
                    <h5><?php echo get_phrase('status'); ?> : <?php echo $row['status'] ? 'Paid' : 'Unpaid'; ?></h5>
                </td>
            </tr>
        </table>
        <hr>
        ...
        <table width="100%" border="0">    
            ...
            <tr>
                ...
                <td align="right"><h4><?php echo ($row['amount']-$row['amount_paid']); ?></h4></td>
            </tr>
            <?php endif;?>
        </table>
